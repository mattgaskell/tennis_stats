...
100.*(winner_return_pts_won + loser_return_pts_won)/(winner_return_pts + loser_return_pts) as pc_return_pts_won,
...
100.*(winner_return_games_won + loser_return_games_won)/(winner_return_games + loser_return_games) as pc_return_games_won,
